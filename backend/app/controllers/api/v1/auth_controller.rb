class Api::V1::AuthController < ApplicationController
  ...
  def send_signup_otp
    ...
    otp = sprintf("%06d", rand(100_000..999_999))
    user.update_columns(otp_code: otp, otp_sent_at: Time.current)
    ...
    render json: {
      ...
      debug_otp: (Rails.env.development? ? otp : nil)
    }, status: :ok
  ...
  def complete_signup
    ...
    if user.otp_code.blank? || user.otp_code != otp
